...
export type Project = {
  ...
  lead: string
  description: string
  // Optional shorter ingress for the mobile card. Falls back to `lead`.
  // The mobile card only renders this single paragraph (no description).
  leadMobile?: string
  heroImage: string
...
export const projects: readonly Project[] = [
  ...
  },
  {
    ...
    leadMobile:
      "Five years designing OP Mobiili — Finland's largest bank, 40M+ monthly interactions. Led the UX chapter of ~50 designers.",
